...
class Minimax {
  ...
  int minimax(
      BoardClass board, int depth, int currentPlayer, int alpha, int beta) {
    ...
    if (depth > maxDepth) return cutOffEvaluation(board, alternatePlayer);
